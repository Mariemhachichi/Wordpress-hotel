...
class Restaurant_Zone_Loader {
	 ...
	 * @return void
	 */
	public function restaurant_zone_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function restaurant_zone_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function restaurant_zone_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function restaurant_zone_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->restaurant_zone_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function restaurant_zone_load( $class ) {
