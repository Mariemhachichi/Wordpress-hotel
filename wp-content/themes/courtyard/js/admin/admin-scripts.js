...
jQuery(document).ready( function() {
  jQuery('#page_template').change(function() {
    ...
    jQuery('#service_related_post').toggle(jQuery(this).val() == 'page-templates/template-services.php');
    jQuery('#packages_related_post').toggle(jQuery(this).val() == 'page-templates/template-packages.php');
  }).change();
});
