...
<form method="POST" class="mphb_cb_reserve_rooms" action="<?php echo esc_url( $actionUrl ); ?>">
		...
		<table class="widefat striped fixed">
			<thead>
				<tr>
					...
					<th class="row-title"><?php _e( 'Title', 'motopress-hotel-booking' ); ?></th>
					<th class="row-title"><?php _e( 'Capacity', 'motopress-hotel-booking' ); ?></th>
					<th class="row-title"><?php _e( 'Base price', 'motopress-hotel-booking' ); ?></th>
				</tr>
			</thead>
			<tbody>
				<?php foreach ( $rooms as $room ) { ?>
					<tr>
						...
						<td>
							<?php
								echo __( 'Adults:', 'motopress-hotel-booking' ), '&nbsp;', esc_html( $room['adults'] ), ' ';
								echo __( 'Children:', 'motopress-hotel-booking' ), '&nbsp;', esc_html( $room['children'] );
							?>
						</td>
						<td>
							<?php echo mphb_format_price( $room['price'] ); ?>
						</td>
					</tr>
				<?php } ?>
			</tbody>
	...
	<p class="mphb-submit-button-wrapper">
		<input type="submit" class="button button-primary" value="<?php _e( 'Reserve', 'motopress-hotel-booking' ); ?>" />
	</p>
