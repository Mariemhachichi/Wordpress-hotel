...
class NotesListField extends RulesListField {
    ...
    public function __construct( $name, $details, $value = '' ){
        ...
        if ( is_array( $details['fields'] ) ) {
            ...
            $this->fields[] = Fields\FieldFactory::create( 'date', array(
                'type'			 => 'text',
                'size'			 => 'small',
                'default'    => time(),
            ...
            $this->fields[] = Fields\FieldFactory::create( 'user', array(
                'type'			 => 'text',
    ...
    protected function renderDateField( $field ) {
        ...
        echo '<div class="mphb-ctrl-wrapper ' . $field->getCtrlClasses() . '" data-type="timestamp">';
    ...
    protected function renderUserField( $field ) {
        ...
        echo '<div class="mphb-ctrl-wrapper ' . $field->getCtrlClasses() . '" data-type="username">';
    ...
    protected function renderDateInput( $field ) {
        ...
        $result .= '<input name="' . esc_attr( $field->getName() ) . '" value="' . $field->getValue() . '" id="' . MPHB()->addPrefix( $field->getName() ) . '" type="hidden" />';
